...
/*
incluir 
9611 Trabajadores domésticos
5222 Cuidadores de niños, personas con discapacidad y ancianos en casas particulares
9643 Lavanderos y planchadores domésticos
8343 Choferes en casas particulares
5113 Cocineros domésticos
*/
...
tab hli [w=factor] if trabajador==1 & trab_dom==1,
...
gen ing_x_hora= ing_lab/htrab
tabstat (ing_lab ing_x_hora) [w=factor] if trab_dom==1, s(p50)
tabstat (ing_lab ing_x_hora) [w=factor] if trab_dom==0, s(p50)
